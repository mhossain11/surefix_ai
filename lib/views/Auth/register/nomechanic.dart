...
import 'package:surefix_ai/helpers/textformfield.dart';
import 'package:surefix_ai/utils/images.dart';
...
class _NoMechanicState extends State<NoMechanic> {
  ...
  late UserRegisterController userRegisterController;
  late UserRegisterController? userRegisterControllerVar;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      userRegisterController.userNameList(context: context);
    });
  ...
  void didChangeDependencies() {
    userRegisterController = Provider.of<UserRegisterController>(context, listen: false);
    userRegisterControllerVar = Provider.of<UserRegisterController>(context, listen: true);
  ...
  search(){
    filter =userRegisterController.nameList.contains(userRegisterController.userNameController.text);
    if(filter == true){
      setState(() {
  ...
  void _submitForm(){
    ...
    if (_formKey.currentState!.validate() && isChecked == true) {
       userRegisterController.userCreateAccount(context: context);
  ...
  void dispose() {
    ...
    userRegisterController.emailAddressController.clear();
    userRegisterController.userNameController.clear();
    userRegisterController.conformPasswordController.clear();
    userRegisterController.fullNameController.clear();
    userRegisterController.numberController.clear();
    userRegisterController.passwordController.clear();
  ...
  Widget build(BuildContext context) {
    print('list:${userRegisterController.nameList.length}');
    return Scaffold(
      appBar: AppBar(
              ...
              children: [
                ...
                SizedBox(
                  child: TextFormFields(
                    controller: userRegisterController.fullNameController,
                    minLines: 1,
                    maxLines: 1,
                ...
                SizedBox(
                  child: TextFormFields(
                    controller: userRegisterController.emailAddressController,
                    minLines: 1,
                    maxLines: 1,
                    cursorColor: themeColor,
                ...
                SizedBox(
                  child: TextFormFields(
                    controller:userRegisterController.numberController,
                    minLines: 1,
                    maxLines: 1,
                    cursorColor: themeColor,
                ...
                Row(
                  children: [
                    SizedBox(
                      width:ProjectResource.screenWidth-50,
                      child: TextFormFields(
                      ...
                      //  focusedBorderSide: const BorderSide(color: Colors.blueAccent),
                        ...
                        suffixIcon: IconButton(
                          ...
                          icon: userRegisterController.userNameController.text.isNotEmpty? const Icon(Icons.clear,color: Colors.black12,):const SizedBox(),
                ...
                Row(
                  children: [
                    SizedBox(
                      width: ProjectResource.screenWidth-50,
                      child: TextFormFields(
                        controller: userRegisterController.passwordController,
                        minLines: 1,
                        maxLines: 1,
                        obscureText: true,
                        cursorColor: themeColor,
                ...
                SizedBox(
                  child: TextFormFields(
                    controller: userRegisterController.conformPasswordController,
                    minLines: 1,
                    maxLines: 1,
                    obscureText: true,
                    cursorColor: themeColor,
                    ...
                    validators: (String? value) {
                      if(value!.isEmpty){
                        return 'Please enter a password';
                      }else if(value != userRegisterController.passwordController.text){
                ...
                Stack(
                  children: [
                    Center(
                      child: userRegisterController.profileImage != null
                          ? Image.file(
                        userRegisterController.profileImage!, width: 160, height: 160, fit: BoxFit.cover,)
                          : const SizedBox(),
                    ),
                    Visibility(
                      visible:userRegisterController.profileImage != null,
                      child: Positioned(
                          left: 215,
                          child: IconButton(
                ...
                const SizedBox(height: 10,),
                ElevatedButtons(
                  onPressed: isChecked==true ? _submitForm : _submitForm,
                  fixedSize: const Size(350, 50),
                  backgroundColor: themeColor,
                  shape: const RoundedRectangleBorder(
                      borderRadius: BorderRadius.all(Radius.circular(5))),
                  child:userRegisterController.loading == false
  ...
  profileImages() async{
    try{
      ...
      setState(() {
        userRegisterController.profileImage = File(result.path) ;
      });
    }catch(e){
      print(e.toString());
    }
  ...
  deleteImage() async{
    if(userRegisterController.profileImage != null && await userRegisterController.profileImage!.exists()) {
      await userRegisterController.profileImage?.delete();
      setState(() {
        userRegisterController.profileImage = null;
      });
