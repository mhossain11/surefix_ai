...
class _YesMechanicState extends State<YesMechanic> {
  ...
  late MechanicRegisterController mechanicController;
  late MechanicRegisterController mechanicControllerVar;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      mechanicController.userNameList(context: context);
    });
  }
  ...
  void didChangeDependencies() {
    mechanicController =
        Provider.of<MechanicRegisterController>(context, listen: false);
    mechanicControllerVar =
        Provider.of<MechanicRegisterController>(context, listen: true);
    super.didChangeDependencies();
  }

  Widget openCustomText(String title) {
    return  Text(title,style: const TextStyle(color: themeColor),);
  }

  search(){
    filter =mechanicController.nameList.contains(mechanicController.userNameController.text);
    if(filter == true){
      setState(() {
        isNameShowVisible =true;
      });
    }else{
      setState(() {
        isNameShowVisible=false;
      });
    }
  }
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Column(
          ...
          children: [
            Text('Register as professional mechanic user',style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.bold),),
            //Text('Create an account,it\'s free',style: TextStyle(color: themeColor,fontSize: 14),),
          ],
        ),
              ...
              children: [
                ...
                SizedBox(
                  child: TextFormFields(
                    controller: mechanicController.fullNameController,
                ...
                const SizedBox(height: 10,),
                TextFormFields(
                  controller: mechanicController.emailAddressController,
                ...
                SizedBox(
                  child: TextFormFields(
                    controller:mechanicController.numberController,
                    minLines: 1,
                    maxLines: 1,
                    cursorColor: themeColor,
                ...
                Row(
                  children: [
                    SizedBox(
                      width:ProjectResource.screenWidth*.85,
                      child: TextFormFields(
                        controller: mechanicController.userNameController,
                        onChanged: (value){
                          setState(() {
                            search();
                          });
                        ...
                        suffixIcon: IconButton(
                          onPressed: () {
                            mechanicController.userNameController.clear();
                            setState(() {
                              filter=false;
                            });
                          },
                          icon: mechanicController.userNameController.text.isNotEmpty? const Icon(Icons.clear,color: Colors.black12,):const SizedBox(),
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                          width: ProjectResource.screenWidth*.05,
                          height: 30,
                          child: InkWell(
                              onTap: (){
                                setState(() {
                ...
                Visibility(
                  visible: isNameShowVisible,
                  child: filter == false? const Text('')
                      :const Text('User name is exist!',style: TextStyle(color: themeColor),),
                ),
                ...
                Row(
                  children: [
                    SizedBox(
                      width:ProjectResource.screenWidth*.85,
                      child: TextFormFields(
                        controller: mechanicController.passwordController,
                        minLines: 1,
                        maxLines: 1,
                        obscureText: true,
                        cursorColor: themeColor,
                ...
                SizedBox(
                  child: TextFormFields(
                    controller: mechanicController.conformPasswordController,
                    minLines: 1,
                    maxLines: 1,
                    obscureText: true,
                    cursorColor: themeColor,
                    ...
                    validators: (String? value) {
                      if(value!.isEmpty){
                        return 'Please enter a password';
                      }else if(value != mechanicController.passwordController.text){
                ...
                Stack(
                  children: [
                    Center(
                      child: mechanicController.profileImage != null
                          ? Image.file(
                        mechanicController.profileImage!, width: 160, height: 160, fit: BoxFit.cover,)
                          : const SizedBox(),
                    ),
                    Visibility(
                      visible: mechanicController.profileImage != null,
                      child: Positioned(
                          left: 215,
                          child: IconButton(
                ...
                Visibility(
                    ...
                    child: openCustomText('Please upload image. jpeg, png ')),
                const SizedBox(height: 10,),
               Stack(
                 children: [
                   Center(
                   ...
                   Visibility(
                     visible: mechanicController.image != null,
                     child: Positioned(
                         left: 215,
                         child: IconButton(
                           icon: const Icon(Icons.clear,color: Colors.grey,), onPressed: () {
                ...
                Padding(
                  ...
                  child: ElevatedButtons(
                      onPressed: () {
                        if (_formKey.currentState!.validate() && isChecked == true && mechanicController.dropdownValue!=0) {
                          mechanicController.performCreateAccount(context: context);
                        } else if(mechanicController.dropdownValue.isEmpty){
                          ...
                          SnackBars.showSnackBar(
                              context: context,
                              content: 'please fill up term and condition form!!',
                              durationSec: 3,
                              success: false,
                              routeAction: null);
                        } else {
                      ...
                      child:mechanicController.loading == false
                          ?
                      const Text(
                        "Register",
                        style: TextStyle(
                ...
                IntrinsicHeight(
                  child: Row(
                    children: [
                       Container(
                         width: ProjectResource.screenWidth * .90,
                         height: ProjectResource.screenHeight * .25 ,
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(children: [
                                    SizedBox(
                                      width: ProjectResource.screenWidth*.80,
                                      height: 50,
                                      child:
                                      CheckboxListTile(
                                          value: isChecked ,
  ...
  profileImages() async{
    ...
    try{
      ...
      if(result == null) return;
      setState(() {
        mechanicController.profileImage = File(result.path);
      });
    }catch(e){
      print(e.toString());
    }
  ...
  deleteImage() async{
    if(mechanicController.profileImage != null && await mechanicController.profileImage!.exists()) {
      await mechanicController.profileImage!.delete();
      setState(() {
        mechanicController.profileImage = null;
      });
  ...
  Widget dropDownButtons(){
    return DropdownButtonFormField(
        ...
        value: mechanicController.dropdownValue,
        ...
        items: const [
          ...
          DropdownMenuItem(value: '1',child: Text('Senior Technician')),
          DropdownMenuItem(value: '2',child: Text('Master Technician')),

        ],
        onChanged: (String? newValue){
          setState(() {
            mechanicController.dropdownValue = newValue!;
          });
  ...
  Widget specialistDropDownButtons(){
    return SizedBox(
      ...
      child: MultiSelectDropDown(
        ...
        controller: mechanicController.controller,
        onOptionSelected: (options) {
          print(options.toString());
          mechanicController.selectedOption.clear();
          setState(() {
            for(var i=0;i< mechanicController.controller.selectedOptions.length;i++){
              mechanicController.selectedOption.add(mechanicController.controller.selectedOptions[i].value);
            }
          });
          print('s:${mechanicController.selectedOption.toString()}');
