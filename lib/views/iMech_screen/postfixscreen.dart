...
class PostFixScreen extends StatefulWidget {
   String tokensp = '';
  String? noDrawer;
  //CreateRequest({super.key,  this.noDrawer});
   PostFixScreen( {super.key,required this.tokensp});

  @override
  State<PostFixScreen> createState() => _PostFixScreenState();
}

class _PostFixScreenState extends State<PostFixScreen> {
  ...
  final TextEditingController fixTitleController= TextEditingController();
  final TextEditingController fixDescriptionController = TextEditingController();
  FocusNode titleControllerNode = FocusNode();
  FocusNode fixTitleControllerNode = FocusNode();
  FocusNode descriptionControllerNode = FocusNode();
  FocusNode fixDescriptionControllerNode = FocusNode();
  ...
  getDescriptionField(controller,String emptyText){
    return   Padding(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            getDescriptionField(descriptionController,'Please enter a description'),
            const SizedBox(height: 10,),
            //Image picker
           // getFileInforamtionField(),
            const Row(children: [
            ...
            const Row(
                ...
                children:[
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 10.0),
                    child: Text('Post Fix Title',style: TextStyle(fontWeight: FontWeight.bold),),
                  ),
                ]),
            Padding(
              padding: const EdgeInsets.all(10),
              child: TextFormField(
                ...
                focusNode: fixTitleControllerNode,
                maxLines: 1,
                cursorColor: Colors.grey,
                keyboardType: TextInputType.text,
                decoration:  InputDecoration(
                ...
                validator: (String? value){
                  if(value!.isEmpty){
                    return 'Please enter a post fix title';
                  }else{
                    return null;
                  }
                },
            ...
            const Row(
                ...
                children:[
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 10.0),
                    child: Text('Post Fix Description',style: TextStyle(fontWeight: FontWeight.bold),),
                  ),
                ]),
            getDescriptionField(fixDescriptionController,'Please enter a post fix description'),
            const SizedBox(height: 20,),
            //Button
            getSaveButton(),
            //Text
